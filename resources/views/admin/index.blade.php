                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-column flex-lg-row">
                                <div class="data-wrapper d-flex mt-2 mt-lg-0">
                                    <div class="wrapper pe-5" style="margin-right: 60px; margin-top:20px;">
                                        <h5 class="mb-0">Total Cost</h5>
                                        <div class="d-flex align-items-center">
                                            <h4 class="font-weight-semibold mb-0">15,263</h4>
                                            {{-- <small class="ms-2 text-gray d-none d-lg-block"><b><br>89.5%</b> of 20,000
                                                Total</small> --}}
                                        </div>
                                    </div>
                                    <div style="margin-right: 30px; margin-top:20px;" class="wrapper">
                                        <h5 class="mb-0">Total Revenue</h5>
                                        <div class="d-flex align-items-center">
                                            <h4 class="font-weight-semibold mb-0">Rs 9,45,456</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="ms-lg-auto" id="sales-statistics-legend">
                                    <div class="chartjs-legend">
                                        <ul>
                                            <li><span
                                                    style="background-color:#8862e0; margin-left:100px;"></span>Revenue
                                            </li>
