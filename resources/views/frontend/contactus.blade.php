...
@section('content')
                ...
                <div class="col-lg-5">
                    ...
                    <div class="single-contact mb-40">
                        ...
                        <div class="content">
                            <span>Call Now</span>
                            <h6><a href=""><span class="__cf_email__"
                                        data-cfemail="0a63646c654a6f726b677a666f24696567">+977-98******</span></a>
                            </h6>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-inner mb-30">
                                        ...
                                        <input type="text" name="fullname" placeholder="Jackson Mile" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-inner mb-30">
                                ...
                                <div class="col-md-12">
                                    <div class="form-inner mb-30">
                                        ...
                                        <textarea name="shortnotes" placeholder="Write Something..." required></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="col-md-12">
    ...
    <div class="contact-map">
        <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d112488.25482335826!2d83.87421753369676!3d28.22984895602121!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3995937bbf0376ff%3A0xf6cf823b25802164!2sPokhara!5e0!3m2!1sen!2snp!4v1713696566326!5m2!1sen!2snp"
