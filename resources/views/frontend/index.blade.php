            ...
            <div class="row g-lg-4 gy-5">
                <div class="col-lg-7 d-flex align-items-center">
                    <div class="banner-content">
                        <span>Elite Vehicle Dealer</span>
                        <h1>Aarambha Motors</h1>
                        <p>Sell your Vehicles</p>
                        ...
                        <div class="row justify-content-center g-xl-0 gy-5">
                            <div class="col-lg-3 col-sm-6">
                                <div class="single-work-process text-center">
                                    ...
                                    <div class="icon">
                                        <img src="{{ asset('assets/img/location.png') }}" height="5px;" alt>
                                    </div>
                                    <div class="content">
                                        <h6>Choose Any where</h6>
                                        <p>Vehicles can be easily listed from different locations.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-sm-6">
                                <div class="single-work-process text-center">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>Contact with us for both buying and selling of used vehicles.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-sm-6">
                                <div class="single-work-process text-center">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>Paying for the vehicle after getting the test ride.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-sm-6">
                                <div class="single-work-process text-center">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>Receive the Vehicle of your choice after the Payment.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
