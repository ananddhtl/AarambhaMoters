                    ...
                    <div class="banner-img-group">
                        <div class="top-img-group">
                            ...
                            <div class="top-right-img">
                                <img src="{{asset('html/assets/img/banner-img-01.png')}}" alt>
                            </div>
                        </div>
                        <div class="bottom-img-group">
                            <div class="bottom-left-img">
                                <img src="{{asset('html/assets/img/banner-img-02.png')}}" alt>
                            </div>
                            <div class="bottom-right-img">
                                <img src="{{asset('html/assets/img/banner-img-03.png')}}" alt>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="home6-filter-area d-flex align-items-center justify-content-between">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="featured-car-tab" data-bs-toggle="tab"
                                    data-bs-target="#featured-car" type="button" role="tab"
                                    aria-controls="featured-car" aria-selected="true">Featured Car</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="latest-car-tab" data-bs-toggle="tab"
                                    data-bs-target="#latest-car" type="button" role="tab" aria-controls="latest-car"
                                    aria-selected="false">Latest Car</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="new-car-tab" data-bs-toggle="tab" data-bs-target="#new-car"
                                    type="button" role="tab" aria-controls="new-car" aria-selected="false">Newly
                                    Listed</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="low-milege-tab" data-bs-toggle="tab"
                                    data-bs-target="#low-milege" type="button" role="tab"
                                    aria-controls="low-milege" aria-selected="false">Lowest Mileage</button>
                            </li>
                        </ul>
            ...
            <div class="row mb-40">
                <div class="col-lg-12">
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="latest-car" role="tabpanel" aria-labelledby="latest-car-tab">
                            <div class="row g-4">
                        ...
                        <div class="tab-pane fade" id="low-milege" role="tabpanel" aria-labelledby="low-milege-tab">
                            <div class="row g-4">
                                <div class="col-lg-4 col-md-6">
                                    <div class="product-card4 style-3">
                                        <div class="product-img">
                ...
                <div class="col-lg-12">
                    <div class="home6-filter-area d-flex align-items-center justify-content-between">
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="price1-tab" data-bs-toggle="tab"
                                    data-bs-target="#price1" type="button" role="tab" aria-controls="price1"
                                    aria-selected="true">01-06 Lakhs</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="price2-tab" data-bs-toggle="tab"
                                    data-bs-target="#price2" type="button" role="tab" aria-controls="price2"
                                    aria-selected="false">07-10
                                    Lakhs</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="price3-tab" data-bs-toggle="tab"
                                    data-bs-target="#price3" type="button" role="tab" aria-controls="price3"
                                    aria-selected="false">11-15
                                    Lakhs</button>
                            </li>
                        </ul>
            ...
            <div class="row wow fadeInUp" data-wow-delay="400ms">
                <div class="col-lg-12">
                    <div class="tab-content" id="myTab2Content">
                        ...
                        <div class="tab-pane fade" id="price2" role="tabpanel" aria-labelledby="price2-tab">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="swiper home6-top-use-car-slider">
                                        <div class="swiper-wrapper">
                                                ...
                                                <div class="product-card4 style-3">
                                                    <div class="product-img">
                                                        ...
                                                        <div class="swiper product-img-slider">
                                                            <div class="swiper-wrapper">
                                                                <div class="swiper-slide">
                                                                    <img src="assets/img/home4/letest-car1.png"
                                                                        alt="image">
                                                                </div>
                                                                <div class="swiper-slide">
                                                                    <img src="assets/img/home4/letest-car1.png"
                                                ...
                                                <div class="product-card4 style-3">
                                                    <div class="product-img">
                                                        ...
                                                        <div class="swiper product-img-slider">
                                                            <div class="swiper-wrapper">
                                                                <div class="swiper-slide">
                                                                    <img src="assets/img/home4/letest-car3.png"
                                                                        alt="image">
                                                                </div>
                                                                <div class="swiper-slide">
                                                                    <img src="assets/img/home4/letest-car3.png"
                                                ...
                                                <div class="product-card4 style-3">
                                                    <div class="product-img">
                                                        ...
                                                        <div class="swiper product-img-slider">
                                                            <div class="swiper-wrapper">
                                                                <div class="swiper-slide">
                                                                    <img src="assets/img/home4/letest-car2.png"
                                                                        alt="image">
                                                                </div>
                                                                <div class="swiper-slide">
                                                                    <img src="assets/img/home4/letest-car2.png"
                        ...
                        <div class="tab-pane fade" id="price3" role="tabpanel" aria-labelledby="price3-tab">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="swiper home6-top-use-car-slider">
                                        <div class="swiper-wrapper">
